...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Formulir Input Data Penduduk</h2>
            <p class="section-lead">Halaman ini untuk mengisi formulir data Penduduk baru atau pendatang</p>
            <div class="row">
                <div class="col-12 col-md-6 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/save_input_penduduk" method="post" enctype="multipart/form-data" id="form-input">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="kk" id="kk" value="<?= old('kk') ?>" class="form-control" placeholder="Harus 16 Digit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nama_ayah" id="nama_ayah" value="<?= old('nama_ayah') ?>" class="form-control" placeholder="Nama lengkap Ayah">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nama_ibu" id="nama_ibu" value="<?= old('nama_ibu') ?>" class="form-control" placeholder="Nama lengkap Ibu">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="status_keluarga" name="status_keluarga">
                                                ...
                                                <option value="0">Sebagai Bapak</option>
                                                <option value="1">Sebagai Ibu</option>
