                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>Semua Penduduk</h4>
                        </div>
                        <div class="card-body">
                            <?= $allVillagers ?>
                        </div>
                        <a href="/admin/penduduk" class="text-decoration-none">Lihat Detail <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <a href="/admin/kematian" class="text-decoration-none">Lihat Detail <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <a href="/admin/pindah" class="text-decoration-none">Lihat Detail <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <div class="btn-group">
                                <a href="#" class="btn btn-primary">Perminggu</a>
                                <a href="#" class="btn">Perbulan</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
