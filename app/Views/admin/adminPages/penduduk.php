    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Penduduk Aktif</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Data Penduduk Aktif</h2>
            <p class="section-lead">
                Halaman ini berisi penduduk yang tetap, masih hidup dan pendatang baru.
            </p>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="/admin/input_penduduk" class="btn btn-primary ml-auto">Input Data Penduduk</a>
                        </div>
                        <div class="card-body">
                            <select class="form-control selectric" id="filters">
                                <option value="" selected disabled>-- Filter Data --</option>
                                <option value="">Semua Penduduk</option>
                                <option value="0">Penduduk Aktif</option>
                            </select>
                            <div class="table-responsive mt-3">
                                <table class="table table-striped" id="data-penduduk">
                                    <thead>
                                        <tr>
                                            <th>No</th>
...
<script>
    ...
    $(document).ready(function() {
        table = $('#data-penduduk').dataTable({
            ...
            "order": [],
            "ajax": {
                "url": "/admin/showData_2/data_penduduk",
                "type": "POST",
                "data": function(response) {
                    response.status_tinggal = $('#filters').val()
                }
            },
            "columnDefs": [{
                    "targets": [1, 2, 4, -1],
