            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/save_kematian_penduduk" method="post" enctype="multipart/form-data" id="form-input">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tanggal_kematian" id="tanggal_kematian" class="form-control datetimepicker" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="penyebab" id="penyebab" class="form-control" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="tempat_pemakaman" id="tempat_pemakaman" class="form-control" style="height: 138px;" readonly></textarea>
        ...
        $('#nik').change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#pekerjaan').removeAttr('readonly')
                    $('#umur').removeAttr('readonly')
                    $('#tanggal_kematian').removeAttr('readonly')
                    $('#penyebab').removeAttr('readonly')
                    $('#tempat_pemakaman').removeAttr('readonly')
                }
            })
        })
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        $('#tanggal_kematian').attr('readonly', true)
                        $('#penyebab').attr('readonly', true)
                        $('#tempat_pemakaman').attr('readonly', true)
