    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Master Pendidikan</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Formulir Input Data Pendidikan</h2>
            <p class="section-lead">Halaman ini untuk mengisi formulir data Pendidikan</p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/save_master_pendidikan" method="post" id="form-input" autocomplete="off">
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pendidikan</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="pendidikan" id="pendidikan" class="form-control" autofocus>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table-pendidikan').dataTable({
            ...
            "order": [],
            "ajax": {
                "url": "/admin/showData/master_pendidikan",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [2, -1],
    ...
    function deletePendidikan(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/admin/delete_pendidikan/' + id,
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        id: id
    ...
    $('#form-input').submit(function(event) {
        ...
        $.ajax({
            url: '/admin/save_master_pendidikan',
            type: 'POST',
            dataType: 'json',
            data: $(this).serialize(),
            beforeSend: function() {
